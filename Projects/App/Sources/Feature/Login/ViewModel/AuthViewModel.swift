...
// Auth가 처음 발생할 때 Fetch or 로그인할 때 fetch

@MainActor
final class AuthViewModel: ObservableObject {
    
    @Published var currentUser: User?  // Current Firebase auth user.
    @Published var userSession: FirebaseAuth.User?
    @Published var authState = AuthState.signedOut  // Auth state for current user.
